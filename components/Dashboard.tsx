          ...
          <div className="flex items-center gap-4">
            {!isGuest && (
              <button 
                ...
                className="flex items-center gap-1 text-sm relative group"
              >
                <svg 
                  className="w-4 h-4 border-b border-transparent group-hover:border-current transition-colors" 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
                ...
                <span className="border-b border-transparent group-hover:border-current transition-colors">フレンド</span>
